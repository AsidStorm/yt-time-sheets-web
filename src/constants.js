...
// Поля формы
export const FILTER_FIELD_USERS = "USERS";
export const FILTER_FIELD_PROJECTS = "PROJECTS";
export const FILTER_FIELD_QUEUES = "QUEUES";
export const FILTER_FIELD_ISSUE_TYPES = "ISSUE_TYPES";
export const FILTER_FIELD_QUERY = "QUERY";
export const FILTER_FIELD_TIME_FORMAT = "TIME_FORMAT";
export const FILTER_FIELD_RESULT_GROUPS = "RESULT_GROUPS";

export const FILTER_FIELD_DATE_FROM = "DATE_FROM";
export const FILTER_FIELD_DATE_TO = "DATE_TO";

export const FILTER_FIELD_ISSUE_STATUSES = "ISSUE_STATUSES";
export const FILTER_FIELD_MOVED_TO_STATUS_MONTH = "MOVED_TO_STATUS_MONTH";
export const FILTER_FIELD_MOVED_TO_STATUS_YEAR = "MOVED_TO_STATUS_YEAR";
export const FILTER_FIELD_SHOULD_OPTIMIZE = "SHOULD_OPTIMIZE";
export const FILTER_FIELD_DATE_FORMAT = "DATE_FORMAT";
export const FILTER_FIELD_HIDE_DETAILS = "HIDE_DETAILS";
export const FILTER_FIELD_HIGHLIGHT_TIME = "HIGHLIGHT_TIME";

export const FILTER_FIELD_DATES_MODE = "DATES_MODE";

export const FILTER_DATE_MODE_STATUSES = "STATUSES";
export const FILTER_DATE_MODE_DATES = "DATES";